...
class BST:
    ...
    def _are_flipped_aux(self, sourcenode, targetnode):
        """
        -------------------------------------------------------
        ...
        if sourcenode is not None and targetnode is None or targetnode is not None and sourcenode is None:
            status =  False
        elif sourcenode is None and targetnode is None:
            status =  True
        elif sourcenode._value != targetnode._value:
            status =  False
        else:
            status = self._are_flipped_aux(sourcenode._left, targetnode._right) and self._are_flipped_aux(sourcenode._right, targetnode._left)
    ...
    def furthest(self):
        ...
        if self._root is not None:
            ...
            while current._left is not None:
                ...
                smallest = current._value

            current = self._root
            while current._right is not None:
                current = current._right
                largest = current._value
