...
class List:
    ...
    def _linear_search(self, key):
        ...
        previous = None
        i = 0
        while i < self._count and current._value is not key:
            previous = current
    ...
    def remove_many(self, key):
        ...
        -------------------------------------------------------
        """
        x, current, _ = self._linear_search(key)
